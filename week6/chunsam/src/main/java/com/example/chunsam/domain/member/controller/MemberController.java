...
public class MemberController {
    ...
    public List<MemberMission> getMissions(@PathVariable("id") Long id){
        ...
        List<MemberMission> progressMissions = memberMissionRepository.findByidAndIssuccess(id, MissionStatus.IN_PROGRESS);
        List<MemberMission> completeMissions = memberMissionRepository.findByidAndIssuccess(id, MissionStatus.COMPLETE);

        return memberMissionRepository.findByid(id); //일단 이렇게 했는데
